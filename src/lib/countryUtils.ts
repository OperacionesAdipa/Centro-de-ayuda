...
export function getCountryHours(country: string): string {
  ...
  const hours: Record<string, string> = {
    ...
    México: summer
      ? 'Lun-Jue 06:00-15:00 · Vie 06:00-13:00 · Sáb 06:00-11:00'
      : 'Lun-Jue 07:00-16:00 · Vie 07:00-14:00 · Sáb 07:00-12:00',
    Colombia: summer
      ? 'Lun-Jue 07:00-16:00 · Vie 07:00-14:00 · Sáb 07:00-12:00'
      : 'Lun-Jue 08:00-17:00 · Vie 08:00-15:00 · Sáb 08:00-13:00',
    Argentina: summer
      ? 'Lun-Jue 09:00-18:00 · Vie 09:00-16:00 · Sáb 09:00-14:00'
      : 'Lun-Jue 10:00-19:00 · Vie 10:00-17:00 · Sáb 10:00-15:00',
  }

  return hours[country] ?? hours['Chile']
}

// Mantener COUNTRY_HOURS para compatibilidad con código existente
